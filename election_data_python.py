...
#Importing Data
election = pd.read_csv(r'C:\Users\UMANG\OneDrive\Desktop\Logistic regression/election_data.csv', sep = ",")
election = election.drop('Election_id', axis = 1)

a1 = election.drop([0],axis = 0)
a1.head(11)
a1.describe()
a1.isna().sum()
...
# Model building 
# import statsmodels.formula.api as sm
logit_model = sm.logit('Result ~ Year + Amount_Spent + Popularity_Rank', data = a1).fit(method ='bfgs')
...
# from sklearn import metrics
fpr, tpr, thresholds = roc_curve(a1.Result, pred)
...
classification = classification_report(a1["pred"], a1["Result"])
classification
